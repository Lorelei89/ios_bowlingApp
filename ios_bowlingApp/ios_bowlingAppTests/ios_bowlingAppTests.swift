//
//  ios_bowlingAppTests.swift
//  ios_bowlingAppTests
//
//  Created by Sabina Buruiana on 3/18/19.
//  Copyright © 2019 Sabina Buruiana. All rights reserved.
//

import XCTest
@testable import ios_bowlingApp


class ios_bowlingAppTests:  XCTestCase {
    var game: Bowling!
    ...
    static var allTests: [(String, (ios_bowlingAppTests) -> () throws -> Void)] {
        return [
